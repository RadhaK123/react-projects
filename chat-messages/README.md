Displaying Deduplicated Chat Messages

There is  a small dataset of chat messages in a JSON file in the data folder. This data must be transformed to meet the following criteria:
